...
import {ListType, TaskType} from '../../redux/todolist-reducer';
...
const TodolistCard: FC<PropsType> = (props) => {
    ...
    return (
        <div
            className='flex flex-col items-center col-span-3 md:col-span-1 py-6 px-1 md:px-6 relative box-border'>
            <Card>
                ...
                <p className="mb-4 min-h-8">{props.list.description}</p>
